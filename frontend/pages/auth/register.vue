        ...
        <div>
          ...
          >
            <svg v-if="isLoading" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
              ...
              <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 00-8 8v8a8 8 0 0014.4 8 8 004 4 4 4 1.707 1.293 2 2a2 2 0 008-2 8v8a2 2 0 012-2v12a2 2 0 00-2 2 2a2 2 0 014-2v12a2 2 0 024-2v6z"></path>
            </svg>
