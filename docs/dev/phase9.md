...
| P9-BE-011 | Create StoreTicketRequest (title, description, client_id nullable+owned, project_id nullable+owned+belongs to client, assigned_to nullable, priority enum, category max 100, tags, deadline nullable future date) | [~] | |
...
| P9-BT-006 | tests/Feature/Tickets/TicketCrudTest.php | [~] | `1112af31` |
