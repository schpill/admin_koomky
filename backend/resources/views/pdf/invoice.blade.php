...
<body>
    ...
    <h2>From</h2>
    <div>{{ $invoice->user?->business_name ?? $invoice->user?->name }}</div>
    ...
    @if ($invoice->user?->bank_details)
        <h2>Bank Details</h2>
        <div>{{ $invoice->user->bank_details }}</div>
    @endif

    @if ($invoice->user?->invoice_footer)
        <h2>Footer</h2>
        <div>{{ $invoice->user->invoice_footer }}</div>
    @endif
</body>
</html>
