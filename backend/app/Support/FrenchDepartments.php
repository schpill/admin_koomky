...
class FrenchDepartments
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['code' => '07', 'name' => 'Ardeche'], ['code' => '08', 'name' => 'Ardennes'], ['code' => '09', 'name' => 'Ariege'],
            ['code' => '10', 'name' => 'Aube'], ['code' => '11', 'name' => 'Aude'], ['code' => '12', 'name' => 'Aveyron'],
            ['code' => '13', 'name' => 'Bouches-du-Rhone'], ['code' => '14', 'name' => 'Calvados'], ['code' => '15', 'name' => 'Cantal'],
            ['code' => '16', 'name' => 'Charente'], ['code' => '17', 'name' => 'Charente-Maritime'], ['code' => '18', 'name' => 'Cher'],
            ['code' => '19', 'name' => 'Correze'], ['code' => '2A', 'name' => 'Corse-du-Sud'], ['code' => '2B', 'name' => 'Haute-Corse'],
            ['code' => '21', 'name' => "Cote-d'Or"], ['code' => '22', 'name' => "Cotes-d'Armor"], ['code' => '23', 'name' => 'Creuse'],
            ['code' => '24', 'name' => 'Dordogne'], ['code' => '25', 'name' => 'Doubs'], ['code' => '26', 'name' => 'Drome'],
            ['code' => '27', 'name' => 'Eure'], ['code' => '28', 'name' => 'Eure-et-Loir'], ['code' => '29', 'name' => 'Finistere'],
            ['code' => '30', 'name' => 'Gard'], ['code' => '31', 'name' => 'Haute-Garonne'], ['code' => '32', 'name' => 'Gers'],
            ['code' => '33', 'name' => 'Gironde'], ['code' => '34', 'name' => 'Herault'], ['code' => '35', 'name' => 'Ille-et-Vilaine'],
            ['code' => '36', 'name' => 'Indre'], ['code' => '37', 'name' => 'Indre-et-Loire'], ['code' => '38', 'name' => 'Isere'],
            ...
            ['code' => '48', 'name' => 'Lozere'], ['code' => '49', 'name' => 'Maine-et-Loire'], ['code' => '50', 'name' => 'Manche'],
            ...
            ['code' => '57', 'name' => 'Moselle'], ['code' => '58', 'name' => 'Nievre'], ['code' => '59', 'name' => 'Nord'],
            ['code' => '60', 'name' => 'Oise'], ['code' => '61', 'name' => 'Orne'], ['code' => '62', 'name' => 'Pas-de-Calais'],
            ['code' => '63', 'name' => 'Puy-de-Dome'], ['code' => '64', 'name' => 'Pyrenees-Atlantiques'], ['code' => '65', 'name' => 'Hautes-Pyrenees'],
            ...
            ['code' => '974', 'name' => 'La Reunion'], ['code' => '976', 'name' => 'Mayotte'],
        ];
    }
}
